...
IndX=1;
VideoObject=VideoReader(a);

FrameSequense(:,:,:,1)=zeros(VideoObject.Height,VideoObject.Width,3);
MaskSequence(:,:,:,1)=zeros(VideoObject.Height,VideoObject.Width);
...
while ~isDone(obj.reader)
   ...
   % display(IndX)
    ...
    FrameSequense(:,:,:,IndX)=frame;
    MaskSequence(:,:,:,IndX)=mask;
    IndX=IndX+1;
...
% foreground objects, and displaying results.
    ...
    function obj = setupSystemObjects()
        ...
        obj.reader = vision.VideoFileReader(a);
...
% indices of tracks and detections that remained unassigned. 
    ...
    function [assignments, unassignedTracks, unassignedDetections] = ...
        ...
        % Compute the cost of assigning each detection to each track (using Kalman Filter here).
